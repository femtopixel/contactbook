<?php
/**
 * Iplocationtool IP geolocation in XML format
 *
 * @package    Core
 ...
 * @version    Paper
 */
class Gears_LocationService_Ip_Iplocationtool_Xml implements Gears_LocationService_Ip_Interface {
	/**
	...
	static public function getIpInfos($ip = null) {
		...
		$client = new Zend_Rest_Client('http://iplocationtools.com/ip_query.php');
